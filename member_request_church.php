...
<body>
    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-md-12">
                <h4>รายการสมาชิกขอเข้าโบสถ์</h4> <a href="church_excel.php?id_no=<?=$_POST['id_no']?>&c_date=<?=$_POST['c_date']?>&around=<?=$_POST['around']?>" class="btn btn-success">EXPORT EXCEL</a>
                <hr>
    ...
    <!-- INNER JOIN member b ON a.m_id = b.m_id
