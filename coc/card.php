      ...
      <ul class="navbar-nav ">
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="dropdownId">
            <a class="dropdown-item" href="card.php">สมาชิก</a>
            ...
            <table class="table table-light table-bordered">
              ...
              <tbody>
                ...
                ?>
                  <tr>
                    <td><?php echo $n; ?></td>
                    <td><?php echo $rs["Tag_Name"]; ?></td>
                    <td><?php echo $rs["Barcode_ID"]; ?></td>
                    <td><?php echo $rs["QR_ID"]; ?></td>
                    <td><?php echo $Group_Name; ?></td>
                    <td> <a class='btn btn-warning btn-sm edit' data-id="<?= $rs['No'] ?>" data-target="#update_data" data-toggle="modal">แก้ไข</a>
                      <a href="card.php?del=true&id=<?= $rs["No"]; ?>" class='btn btn-danger btn-sm' onclick="return confirm('คุณต้องการลบข้อมูลที่เลือก')">ลบ</a>
                    </td>
                  </tr>
                <?php } ?>
              </tbody>
