...
<body>
    ...
    <div class="container  h-75">
        <div class="row justify-content-around">
            <div class="col-md-8  my-5">
                <div class="card box">
                    <div class="card-header">
                        <h5>เพิ่มเวลาเข้าโบสถ์</h5>
                    </div>
                    <div class="card-body">
                        <form id="insert_church_time">
            ...
            <div class="col-md-12">
                <hr>
                <h4>รายการลงเวลาเข้าใช้งานโบสถ์</h4>
                <table class="table table-striped text-center" id="example">
                    ...
                    <tbody>
                        <?php $sql = mysqli_query($conn, "SELECT * FROM church_time order by c_date DESC ");
                        $i = 1;
                        while ($rs = mysqli_fetch_assoc($sql)) { ?>
                            <tr>
                                ...
                                <td><a href="" class="btn btn-danger btn-sm del_church_time" data-id="<?= $rs['c_id'] ?>">ลบ</a></td>
                            </tr>
                        <?php $i++;
                        } ?>
                    </tbody>
