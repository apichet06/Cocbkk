...
<body>
    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-md-12">
                <h4>รายการแขกผู้มาเยี่ยม </h4><a href="visitor_excel.php?id_no=<?= $_POST['id_no'] ?>&c_date=<?= $_POST['c_date'] ?>&around=<?= $_POST['around'] ?>" class="btn btn-success">EXPORT EXCEL</a>
                <hr>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td><a href="#" class="btn btn-danger btn-sm del_visitor" data-id="<?= $rs['i_number'] ?>">ลบ</a></td>
                            </tr>
                        <?php $i++;
                        } ?>
                    </tbody>
